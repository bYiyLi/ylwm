...
public class xcb_format_iterator_t extends Structure {
	/** C type : xcb_format_t* */
	public com.yi.ylwm.xcb.xcb_format_t.ByReference data;
	public int rem;
	public int index;
...
protected List<String> getFieldOrder(){
	...
	/** @param data C type : xcb_format_t* */
	public xcb_format_iterator_t(com.yi.ylwm.xcb.xcb_format_t.ByReference data, int rem, int index) {
		super();
		this.data = data;
		this.rem = rem;
		this.index = index;
