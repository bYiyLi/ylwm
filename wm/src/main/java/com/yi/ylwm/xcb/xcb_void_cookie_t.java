...
protected List<String> getFieldOrder(){
	...
	public xcb_void_cookie_t(int sequence) {
		super();
		this.sequence = sequence;
	}
	public xcb_void_cookie_t(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends xcb_void_cookie_t implements Structure.ByReference {
