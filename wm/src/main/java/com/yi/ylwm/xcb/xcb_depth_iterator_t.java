...
public class xcb_depth_iterator_t extends Structure {
	/** C type : xcb_depth_t* */
	public com.yi.ylwm.xcb.xcb_depth_t.ByReference data;
	public int rem;
	public int index;
...
protected List<String> getFieldOrder(){
	...
	/** @param data C type : xcb_depth_t* */
	public xcb_depth_iterator_t(com.yi.ylwm.xcb.xcb_depth_t.ByReference data, int rem, int index) {
		super();
		this.data = data;
		this.rem = rem;
		this.index = index;
