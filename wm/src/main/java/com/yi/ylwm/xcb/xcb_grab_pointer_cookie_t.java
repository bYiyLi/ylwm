...
public class xcb_grab_pointer_cookie_t extends Structure {
	public int sequence;
	public xcb_grab_pointer_cookie_t() {
		super();
	}
	@Override
protected List<String> getFieldOrder(){
	...
	public xcb_grab_pointer_cookie_t(int sequence) {
		super();
		this.sequence = sequence;
	}
	public xcb_grab_pointer_cookie_t(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends xcb_grab_pointer_cookie_t implements Structure.ByReference {
