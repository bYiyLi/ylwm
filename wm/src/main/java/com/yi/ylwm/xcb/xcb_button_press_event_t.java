...
public class xcb_button_press_event_t extends Structure {
	...
	public byte pad0;
	public xcb_button_press_event_t() {
		super();
	}
	@Override
protected List<String> getFieldOrder(){
	...
	public xcb_button_press_event_t(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends xcb_button_press_event_t implements Structure.ByReference {
		
	};
	public static class ByValue extends xcb_button_press_event_t implements Structure.ByValue {
